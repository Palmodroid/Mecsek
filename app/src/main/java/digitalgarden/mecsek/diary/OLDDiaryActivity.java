 ...
 */
public class OLDDiaryActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState)
        ...
        diaryAdapter = new OLDDiaryAdapter( getSupportFragmentManager(), today.get());
        ...
        vpPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener()
            ...
            public void onPageSelected(int position)
                {
                Toast.makeText(OLDDiaryActivity.this,
...
*/
    ...
    // @Override
    public void onReady(OLDComplexDailyData data)
        {
        dailyListFrame.setVisibility( View.VISIBLE );
